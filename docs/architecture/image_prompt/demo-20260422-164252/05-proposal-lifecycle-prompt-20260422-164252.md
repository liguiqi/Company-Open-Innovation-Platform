...
```text
Create a premium business-process architecture slide in Chinese for the HeT Open Innovation Platform, focused on proposal submission and review lifecycle. Use a high-end enterprise style, HET blue visual identity, 16:9 widescreen composition, and clean layered process arrows.
...
The result should feel like an executive explanation of the business loop from submission to review to controlled file delivery. Add a bottom-right mark reading "Power by LGQ".
```
